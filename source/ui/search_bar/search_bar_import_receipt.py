...
class SearchBarImportReceipt(SearchBarBase):
    def __init__(self, page: ft.Page, service: PhieuNhapSachService, on_search_result):
        """
        on_search_result: Một hàm callback nhận vào một danh sách các phiếu nhập.
        """
